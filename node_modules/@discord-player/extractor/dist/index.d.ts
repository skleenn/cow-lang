...
declare class SoundCloudExtractor extends BaseExtractor<SoundCloudExtractorInit> {
    ...
    static soundcloud: soundcloud_ts.default | null;
...
type IBridgeSource = 'soundcloud' | 'youtube';
